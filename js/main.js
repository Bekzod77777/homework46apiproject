    ...
    <div class="card">
      ...
      <div class="card-body">
        ...
        <div class="d-flex justify-content-between gap-2">
          <button class="btn btn-danger teacher__btn" onclick="deleteTeacher(${id})" >Del</button>
          ...
          <a href="student.html" onclick="saveId(${id})" class="btn btn-danger teacher__btn1"> See students ${id}</a>
        </div>
      </div>
    </div>
  </div>`;
